...
export const ProjectCard = ({ name, description, thumbnail, codeLink, liveLink }) => { 
    return (
        <Wrapper image={thumbnail}>
            <LinksWrapper>
                <Title>{name}</Title>
                <ProjectLink color={colors.orange[100]} target="_blank" href={liveLink}>Live</ProjectLink>
                <ProjectLink color={colors.light[100]} target="_blank" href={codeLink}>Code</ProjectLink>
            </LinksWrapper>
